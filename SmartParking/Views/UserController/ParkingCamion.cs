...
{
    public partial class ParkingCamion : UserControl
    {
        Form4 form4;
        Form5 form5;
        Form6 form6;
        ...
        {
            placeList = PlaceControlle.afficher("Camion");
            foreach (Place item in placeList)
            {
                ...
                {
                    myPanel.BackgroundImage = Properties.Resources.icons8_delivery_truck_96;
                }
                myPanel.BackgroundImageLayout = ImageLayout.Stretch;
                panel1.Controls.Add(myPanel);
                nbrPanel++;
            ...
            if (b != null)
            {
                ...
                if (pl.Status == 1)
                {
                    ...
                    if (form4.ShowDialog() == DialogResult.OK)
                    {
                        ...
                        if (pl != null)
                        {
                            res = new Reservation(form4.Matricule, form4.Fullname, form4.Model, "Camion", "5.00", DateTime.Now, form4.Cin, pl, "en coure");
